...
/*
This program pretends to find the intersection of the heteroclinic manifolds at the section x=0.
*/
...
//if (abs(z1[0])<stop_tol){
	...
	//fout <<setprecision(40)<<"Nan"<<" "<<0<<" "<<dble(z0[1])<<" "<<dble(z1[0])<<" "<<dble(z1[1])<<" "<<dble(z1[2])<<" "<<dble(z1[3])<<" "<<dble(z1[4])<<" "<<dble(*error)<<endl;
